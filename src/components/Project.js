  ...
  return <section className='section mb-32' id='work'>
    <div className="container mx-auto text-center lg:text-left">
      <div className='flex flex-col gap-y-10 gap-x-10 lg:flex-row justify-center items-center'>
        <motion.div variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} className='flex-1 gap-y-12 cursor-pointer'>
          <div>
            ...
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl mt-[70px]'>
              <div className='group-hover:bg-black/80 w-full h-full absolute z-40 transition-all duration-300'></div>
              <img className='group-hover:scale-150 transition-all duration-500' src={portfolio} alt="" />
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'><span className='text-gradient font-bold'>Portfolio Website</span></div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'><span className='text-3xl text-white'>Project Title</span></div>
            </div>
          </div>
        </motion.div>
        <motion.div variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} className='flex-1 gap-y-12 cursor-pointer'>
          <div className='flex flex-col gap-y-6'>
            ...
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'><span className='text-gradient font-bold'>NFT Website Landing Page</span></div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'><span className='text-3xl text-white'>Project Title</span></div>
            </div>
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              <div className='group-hover:bg-black/80 w-full h-full absolute z-40 transition-all duration-300'></div>
              <img className='group-hover:scale-150 transition-all duration-500' src={blog} alt="" />
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'><span className='text-gradient font-bold'>Full Stack Blog Website</span></div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'><span className='text-3xl text-white'>Project Title</span></div>
            </div>
          </div>
        </motion.div>
