  ...
  return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
      <div className="container mx-auto">
        <div className='w-full bg-black/20 h-[96px] backdrop-blur-xl rounded-full max-w-[460px] mx-auto flex justify-between items-center text-2xl px-5 text-white/50'>
          ...
          <Link to='service' className='flex w-[60px] h-[60px] cursor-pointer justify-center items-center' activeClass='active' smooth={true} spy={true} >
            <BsClipboardData />
          </Link>
